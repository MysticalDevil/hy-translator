...
class DownloadUidtJobSchedulerTest {
    ...
    @Test
    fun uidtModelJob_timeoutPersistsInterruptedError() = runBlocking {
        val model = ModelOptions.getByKey("Q4_K_M")
        DownloadServiceDependencies.modelRepositoryFactory = {
        ...
        timeoutScheduledJob(MODEL_DOWNLOAD_UIDT_JOB_ID)
    ...
    @Test
    fun uidtAiAssetJob_timeoutPersistsInterruptedError() = runBlocking {
        DownloadServiceDependencies.aiAssetRepositoryFactory = {
        ...
        timeoutScheduledJob(OCR_DOWNLOAD_UIDT_JOB_ID)
    ...
    private fun timeoutScheduledJob(jobId: Int) {
        instrumentation.uiAutomation
            .executeShellCommand("cmd jobscheduler timeout ${context.packageName} $jobId")
            .readTextAndClose()
    }
